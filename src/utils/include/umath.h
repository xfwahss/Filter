...
// 多元高斯分布随机向量
Eigen::VectorXd multivariate_gaussian_random(Eigen::VectorXd &mean, Eigen::MatrixXd &covariance, const unsigned int& seed=0);

// 向量全部为正值的多元高斯分布
Eigen::VectorXd pos_multi_gauss_random(Eigen::VectorXd &mean, Eigen::MatrixXd &covariance, const unsigned int& seed=0);
